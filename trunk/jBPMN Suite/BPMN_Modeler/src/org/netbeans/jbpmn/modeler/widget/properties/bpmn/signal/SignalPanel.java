 ...
 * the License.
 */
package org.netbeans.jbpmn.modeler.widget.properties.bpmn.signal;
...
public class SignalPanel extends EntityComponent<TSignal> {
    ...
    /**
     * Creates new form CreateSignalPanel
     */
    public SignalPanel(ModelerFile modelerFile) {
        super("Signal Ref", true);
    ...
    public void createEntity(Class<? extends Entity> entityWrapperType) {
        this.setTitle("Create new Signal Element");
        if (entityWrapperType == ComboBoxValue.class) {
            this.setEntity(new ComboBoxValue<TSignal>());
    ...
    @Override
    public void updateEntity(Entity<TSignal> entityValue) {
        this.setTitle("Update Signal Element");
        this.setEntity(entityValue);
        TSignal signal = null;
        if (entityValue.getClass() == ComboBoxValue.class) {
            signal = ((ComboBoxValue<TSignal>) entityValue).getValue();
        } else if (entityValue.getClass() == RowValue.class) {
            Object[] row = ((RowValue) entityValue).getRow();
            signal = (TSignal) row[0];
        }

        name_TextField.setText(signal.getName() == null ? "" : signal.getName());
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(createItem_MenuItem, org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.createItem_MenuItem.text")); // NOI18N
        createItem_MenuItem.setToolTipText(org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.createItem_MenuItem.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(editItem_MenuItem, org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.editItem_MenuItem.text")); // NOI18N
        editItem_MenuItem.setToolTipText(org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.editItem_MenuItem.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(deleteItem_MenuItem, org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.deleteItem_MenuItem.text")); // NOI18N
        deleteItem_MenuItem.setToolTipText(org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.deleteItem_MenuItem.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(dataType_Label, org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.dataType_Label.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(name_Label, org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.name_Label.text")); // NOI18N
        jLayeredPane4.add(name_Label);
        name_Label.setBounds(0, 0, 90, 14);

        name_TextField.setText(org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.name_TextField.text")); // NOI18N
        name_TextField.setToolTipText(org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.name_TextField.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(save_Button, org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.save_Button.text")); // NOI18N
        save_Button.setToolTipText(org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.save_Button.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(cancel_Button, org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.cancel_Button.text")); // NOI18N
        cancel_Button.setToolTipText(org.openide.util.NbBundle.getMessage(SignalPanel.class, "SignalPanel.cancel_Button.toolTipText")); // NOI18N
...
//            }//I18n
    ...
    private void save_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_ButtonActionPerformed
        ...
        if (this.getEntity().getClass() == ComboBoxValue.class) {
            ComboBoxValue<TSignal> comboBoxValue = (ComboBoxValue<TSignal>) this.getEntity();
            if (comboBoxValue.getValue() == null) {
                signal = new TSignal();
                signal.setId(NBModelerUtil.getAutoGeneratedStringId());
            } else {
                signal = comboBoxValue.getValue();
            }
        ...
        signal.setName(name_TextField.getText());
        signal.setStructureRef(((ComboBoxValue<TItemDefinition>) dataType_ComboBox.getSelectedItem()).getId());

        if (this.getEntity().getClass() == ComboBoxValue.class) {
            ComboBoxValue<TSignal> comboBoxValue = (ComboBoxValue<TSignal>) this.getEntity();
            comboBoxValue.setId(signal.getId());
            comboBoxValue.setValue(signal);
            comboBoxValue.setDisplayValue(signal.getName());
        } else if (this.getEntity().getClass() == RowValue.class) {
            Object[] row = ((RowValue) this.getEntity()).getRow();
            row[0] = signal;
