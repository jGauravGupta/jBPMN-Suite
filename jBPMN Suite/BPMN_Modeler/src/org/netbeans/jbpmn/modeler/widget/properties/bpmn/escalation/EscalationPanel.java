 ...
 * the License.
 */
package org.netbeans.jbpmn.modeler.widget.properties.bpmn.escalation;
...
public class EscalationPanel extends EntityComponent<TEscalation> {
    ...
    /**
     * Creates new form CreateEscalationPanel
     */
    public EscalationPanel(ModelerFile modelerFile) {
        super("Escalation Ref", true);
    ...
    public void createEntity(Class<? extends Entity> entityWrapperType) {
        this.setTitle("Create new Escalation Element");
        if (entityWrapperType == ComboBoxValue.class) {
            this.setEntity(new ComboBoxValue<TEscalation>());
    ...
    @Override
    public void updateEntity(Entity<TEscalation> entityValue) {
        this.setTitle("Update Escalation Element");
        this.setEntity(entityValue);
        TEscalation escalation = null;
        if (entityValue.getClass() == ComboBoxValue.class) {
            escalation = ((ComboBoxValue<TEscalation>) entityValue).getValue();
        } else if (entityValue.getClass() == RowValue.class) {
            Object[] row = ((RowValue) entityValue).getRow();
            escalation = (TEscalation) row[0];
        }
        name_TextField.setText(escalation.getName() == null ? "" : escalation.getName());
        code_TextField.setText(escalation.getEscalationCode() == null ? "" : escalation.getEscalationCode());
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(createItem_MenuItem, org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.createItem_MenuItem.text")); // NOI18N
        createItem_MenuItem.setToolTipText(org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.createItem_MenuItem.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(editItem_MenuItem, org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.editItem_MenuItem.text")); // NOI18N
        editItem_MenuItem.setToolTipText(org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.editItem_MenuItem.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(deleteItem_MenuItem, org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.deleteItem_MenuItem.text")); // NOI18N
        deleteItem_MenuItem.setToolTipText(org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.deleteItem_MenuItem.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(name_Label, org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.name_Label.text")); // NOI18N
        name_LayeredPane.add(name_Label);
        name_Label.setBounds(0, 0, 90, 14);

        name_TextField.setText(org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.name_TextField.text")); // NOI18N
        name_TextField.setToolTipText(org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.name_TextField.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(code_Label, org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.code_Label.text")); // NOI18N
        code_LayeredPane.add(code_Label);
        code_Label.setBounds(0, 0, 90, 14);

        code_TextField.setText(org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.code_TextField.text")); // NOI18N
        code_TextField.setToolTipText(org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.code_TextField.toolTipText")); // NOI18N
        code_LayeredPane.add(code_TextField);
        code_TextField.setBounds(90, 0, 250, 20);

        jLayeredPane1.add(code_LayeredPane);
        code_LayeredPane.setBounds(20, 60, 340, 30);

        org.openide.awt.Mnemonics.setLocalizedText(dataType_Label, org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.dataType_Label.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(save_Button, org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.save_Button.text")); // NOI18N
        save_Button.setToolTipText(org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.save_Button.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(cancel_Button, org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.cancel_Button.text")); // NOI18N
        cancel_Button.setToolTipText(org.openide.util.NbBundle.getMessage(EscalationPanel.class, "EscalationPanel.cancel_Button.toolTipText")); // NOI18N
        ...
        action_LayeredPane.setBounds(200, 150, 160, 30);
...
//            }//I18n
    ...
    private void save_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_ButtonActionPerformed
        ...
        if (this.getEntity().getClass() == ComboBoxValue.class) {
            ComboBoxValue<TEscalation> comboBoxValue = (ComboBoxValue<TEscalation>) this.getEntity();
            if (comboBoxValue.getValue() == null) {
                escalation = new TEscalation();
                escalation.setId(NBModelerUtil.getAutoGeneratedStringId());
            } else {
                escalation = comboBoxValue.getValue();
            }
        ...
        escalation.setName(name_TextField.getText());
        escalation.setEscalationCode(code_TextField.getText());
        escalation.setStructureRef(((ComboBoxValue<TItemDefinition>) dataType_ComboBox.getSelectedItem()).getId());

        if (this.getEntity().getClass() == ComboBoxValue.class) {
            ComboBoxValue<TEscalation> comboBoxValue = (ComboBoxValue<TEscalation>) this.getEntity();
            comboBoxValue.setId(escalation.getId());
            comboBoxValue.setValue(escalation);
            comboBoxValue.setDisplayValue(escalation.getName());
        } else if (this.getEntity().getClass() == RowValue.class) {
            Object[] row = ((RowValue) this.getEntity()).getRow();
            row[0] = escalation;
            row[1] = escalation.getName();
            row[2] = escalation.getEscalationCode();
            row[3] = ((ComboBoxValue<TItemDefinition>) dataType_ComboBox.getSelectedItem()).getDisplayValue();
        }
