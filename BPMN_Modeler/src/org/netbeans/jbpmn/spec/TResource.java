...
public class TResource
     ...
     * <CODE>set</CODE> method for the resourceParameter property.
     *
     * <p>
    ...
    public TResourceParameter getResourceParameter(String id) {
        if (resourceParameter == null) {
            resourceParameter = new ArrayList<TResourceParameter>();
        }
        for (TResourceParameter resourceParameter_TMP : resourceParameter) {
            if (resourceParameter_TMP.getId().equals(id)) {
                return resourceParameter_TMP;
            }
        }
        return null;
    }
