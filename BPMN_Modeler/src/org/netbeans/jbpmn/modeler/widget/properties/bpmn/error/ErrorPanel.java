 ...
 * the License.
 */
package org.netbeans.jbpmn.modeler.widget.properties.bpmn.error;
...
public class ErrorPanel extends EntityComponent<TError> {
     ...
     */
    public ErrorPanel(ModelerFile modelerFile) {
        super("Error Ref", true);
    ...
    public void createEntity(Class<? extends Entity> entityWrapperType) {
        this.setTitle("Create new Error Element");
        if (entityWrapperType == ComboBoxValue.class) {
            this.setEntity(new ComboBoxValue<TError>());
    ...
    @Override
    public void updateEntity(Entity<TError> entityValue) {
        this.setTitle("Update Error Element");
        this.setEntity(entityValue);
        TError error = null;
        if (entityValue.getClass() == ComboBoxValue.class) {
            error = ((ComboBoxValue<TError>) entityValue).getValue();
        } else if (entityValue.getClass() == RowValue.class) {
            Object[] row = ((RowValue) entityValue).getRow();
            error = (TError) row[0];
        }
        name_TextField.setText(error.getName() == null ? "" : error.getName());
        code_TextField.setText(error.getErrorCode() == null ? "" : error.getErrorCode());
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(createItem_MenuItem, org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.createItem_MenuItem.text")); // NOI18N
        createItem_MenuItem.setToolTipText(org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.createItem_MenuItem.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(editItem_MenuItem, org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.editItem_MenuItem.text")); // NOI18N
        editItem_MenuItem.setToolTipText(org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.editItem_MenuItem.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(deleteItem_MenuItem, org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.deleteItem_MenuItem.text")); // NOI18N
        deleteItem_MenuItem.setToolTipText(org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.deleteItem_MenuItem.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(name_Label, org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.name_Label.text")); // NOI18N
        name_LayeredPane.add(name_Label);
        name_Label.setBounds(0, 0, 90, 14);

        name_TextField.setText(org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.name_TextField.text")); // NOI18N
        name_TextField.setToolTipText(org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.name_TextField.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(code_Label, org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.code_Label.text")); // NOI18N
        code_LayeredPane.add(code_Label);
        code_Label.setBounds(0, 0, 90, 14);

        code_TextField.setText(org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.code_TextField.text")); // NOI18N
        code_TextField.setToolTipText(org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.code_TextField.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(dataType_Label, org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.dataType_Label.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(save_Button, org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.save_Button.text")); // NOI18N
        save_Button.setToolTipText(org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.save_Button.toolTipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(cancel_Button, org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.cancel_Button.text")); // NOI18N
        cancel_Button.setToolTipText(org.openide.util.NbBundle.getMessage(ErrorPanel.class, "ErrorPanel.cancel_Button.toolTipText")); // NOI18N
...
//            }//I18n
    ...
    private void save_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_ButtonActionPerformed
        ...
        if (this.getEntity().getClass() == ComboBoxValue.class) {
            ComboBoxValue<TError> comboBoxValue = (ComboBoxValue<TError>) this.getEntity();
            if (comboBoxValue.getValue() == null) {
                error = new TError();
                error.setId(NBModelerUtil.getAutoGeneratedStringId());
            } else {
                error = comboBoxValue.getValue();
            }
        ...
        error.setName(name_TextField.getText());
        error.setErrorCode(code_TextField.getText());
        error.setStructureRef(((ComboBoxValue<TItemDefinition>) dataType_ComboBox.getSelectedItem()).getId());

        if (this.getEntity().getClass() == ComboBoxValue.class) {
            ComboBoxValue<TError> comboBoxValue = (ComboBoxValue<TError>) this.getEntity();
            comboBoxValue.setId(error.getId());
            comboBoxValue.setValue(error);
            comboBoxValue.setDisplayValue(error.getName());
        } else if (this.getEntity().getClass() == RowValue.class) {
            Object[] row = ((RowValue) this.getEntity()).getRow();
            row[0] = error;
            row[1] = error.getName();
